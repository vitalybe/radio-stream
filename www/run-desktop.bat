...
ConEmu.exe /single /cmd cmd /k "%ConEmuDir%\..\init.bat & cd www & npm run start-hot" -cur_console:s50V:n:t:"desktop":C:"c:\Users\Vitaly\Dropbox\Utils\Cmder\icons\webpack.ico"
