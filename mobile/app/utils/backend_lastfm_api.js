...
export async function getArtistImage(artist) {
  ...
  try {
    const response = await fetch(`http://ws.audioscrobbler.com/2.0/?method=artist.getinfo&artist=${encodeURIComponent(artist)}&autocorrect=1&api_key=${API_KEY}&format=json`);
